...
AUTO_ADD_TOOLTIP = "Enabling this will allow the system to automatically add members to your newly created or existing group. This feature only works for dungeons.";
