...
ENABLE_HARDWARE = "Hardware Acceleration"; -- Sound Option
...
ERR_UNKNOWN_MACRO_OPTION = "Unknown macro option: %s";
...
LONG_RANGE_NAMEPLATE = "Long Range Name Plates";
LOOKING = "Looking";
...
NEWBIE_TOOLTIP_MEMORY = "How much memory your AddOns are using. You can get to the addon managment page from the character select screen.";
...
OPTION_TOOLTIP_AUTO_DISMOUNT_FLYING = "If enabled, your character will automatically dismount before casting even while flying.";
...
SHOW_TARGET_CASTBAR = "Show Enemy Cast Bar - Portrait"; -- CVar text for the current target castbar
SHOW_TARGET_CASTBAR_IN_V_KEY = "Show Enemy Cast Bar - Name Plate"; -- CVar text for the current target castbar
